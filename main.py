...
class MenuIdioma(ui.View):
    ...
    async def selecionar_idioma(self, interaction: discord.Interaction):
        ...
        # Só envia DM se NÃO for o próprio usuário do comando
...
# Helper para registrar o último usuário do slash
...
# --- Comandos de servidor com SLASH ---
...
# --- Avisos automáticos e comandos de avisos ---
def carregar_envios():
